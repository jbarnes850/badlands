...
- `type`: one of `action_requested`, `action_started`, `action_completed`, `state_transition`, `telemetry_emitted`, `alert_emitted`, `observation_delivered`, `mission_task_event`, `defense_harm_event`, `security_impact_event`, `score_snapshot`, `llm_decision`, `llm_decision_invalid`, `action_rejected`.
